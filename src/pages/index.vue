...
const banner = ref([
  {
    id: 1,
    src: '~/assets/images/slide-banner-1.webp',
    alt: 'Squirrel',
  },
  {
    id: 2,
    src: '~/assets/images/banners/slide-banner-2.webp',
    alt: 'Sky',
  },
  {
    id: 3,
    src: '~/assets/images/banners/slide-banner-1.webp',
    alt: 'Bird',
  },
  {
    id: 4,
...
const slideHeight= ref<string>('30rem')

if(useState('deviceLayout').value === 'mobile') {
  slideHeight.value = '9rem'
}
...
<template>
  <el-carousel :height="slideHeight" motion-blur class="h-full">
    <el-carousel-item v-for="item in banner" :key="item.id">
      <img src="~/assets/images/banners/slide-banner-1.webp" :alt="item.alt" class="w-full object-cover">
    </el-carousel-item>
  </el-carousel>
